...
class Param:
    def __init__(self):
        ...
        # General
        self.parser.add_argument('--exp-config', type=str, default='vlnce_baselines/config/rxr_configs/rxr_cma_en.yaml', help='')
        self.parser.add_argument('--run-type', type=str, default='train', help='')
        ...
        self.parser.add_argument('--name', type=str, default='VLNBERT-train-Prevalent', help='experiment id')
        ...
        self.parser.add_argument("--save-name", type=str, default = '{0:%Y-%m-%dT%H-%M-%S}'.format(datetime.now()))   
